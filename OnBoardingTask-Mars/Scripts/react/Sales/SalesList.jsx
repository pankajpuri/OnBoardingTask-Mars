...
import SalesCreate from './SalesCreate.jsx';
import SalesUpdate from './SalesUpdate.jsx';
import SalesDelete from './SalesDelete.jsx';
            ...
            <React.Fragment>
                <div className="ui one column grid">
                    ...
                    <div className="row">
                            ...
                            <SalesCreate onChange={this.onChange} onClose={this.closeCreateModel} onCreateSubmit={this.onCreateSubmit} showCreateModel={this.state.showCreateModel} />

                    </div>

                    <div className="column">
                        <SalesUpdate onChange={this.onChange} update={this.state.updateId} onClose={this.closeUpdateModel} onUpdateSubmit={this.onUpdateSubmit} showUpdateModel={this.state.showUpdateModel}
                        ...
                        <SalesDelete delete={this.state.deleteId} onClose={this.closeDeleteModal} onDeleteSubmit={this.onDeleteSubmit} showDeleteModal={this.state.showDeleteModal} />
